        ...
        <div className="container">
          ...
          <div className="row flex-column flex-lg-row align-items-lg-center pt-36 border-1 border-top">
            ...
            <div className="col-12 col-lg-4 d-flex justify-content-center">
              <img src="https://github.com/omerceltikk/Turkcell-GYGY-FinalCase/blob/main/final-project-ecommerce/images/Frame.svg" className='order-1 mb-4 mb-lg-0 order-lg-2' alt="" />
            </div>
