            ...
            <div className="row">
                  ...
                  <div className="col-lg-6 pe-lg-34">
                    ...
                    <div className="bg-secondary rounded-2 mt-3 px-14 py-2">
                      <div className="row">
                        <div className="col-12 col-lg-6 d-flex align-items-center">
                          <img src="https://github.com/omerceltikk/Turkcell-GYGY-FinalCase/blob/main/final-project-ecommerce/images/Frame1.svg" alt="" />
                        ...
                        <div className="col-12 col-lg-6 d-flex align-items-center text-start">
                          <img src="https://github.com/omerceltikk/Turkcell-GYGY-FinalCase/blob/main/final-project-ecommerce/images/Frame2.png" alt="" />
                          <div className="display-14 text-primary fw-semibold ms-2">
                    ...
                    <div className="col-12 text-start d-none d-lg-flex gap-3  align-items-center mt-4">
                      <div className="d-flex align-items-center">
                        <img src="https://github.com/omerceltikk/Turkcell-GYGY-FinalCase/blob/main/final-project-ecommerce/images/Share_Android.png" alt="" />
              ...
              <form onSubmit={formik.handleSubmit} className="col-lg-6 ps-lg-0">
                    ...
                    <div className="d-flex">
                      ...
                      >
                        <img
                          src="https://github.com/omerceltikk/Turkcell-GYGY-FinalCase/blob/main/final-project-ecommerce/images/Chat_Dots.png"
                          alt=""
                          className="me-2"
                        />
                        Contact With Seller
