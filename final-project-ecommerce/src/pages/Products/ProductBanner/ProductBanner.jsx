    ...
    <div className='container mt-6'>
      <div className={`row flex-column-reverse position-relative flex-lg-row bg-secondary ${styles.bannerArea} overflow-hidden`}>
        <div className={`col-12 col-lg-7 align-self-end`}>
          ...
          <img src="https://github.com/omerceltikk/Turkcell-GYGY-FinalCase/blob/main/final-project-ecommerce/images/png3.png" className={`mt-0 mt-lg-36 ps-xxl-100 ${styles.imgContent}`} />
          </div>
        </div>
