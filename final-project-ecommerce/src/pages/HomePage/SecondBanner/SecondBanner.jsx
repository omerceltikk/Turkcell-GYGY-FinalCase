      ...
      <div className="row">
        ...
        <div className=" col-12 pb-36 mb-1">
          <div className='row align-items-center'>
            <div className='col-2'>
              <img src="/final-project-ecommerce/images/image-4.png" className='mx-auto d-flex' alt="" />
            </div>
            <div className='col-2'>
              <img src="/final-project-ecommerce/images/image 6.png" className='mx-auto d-flex' alt="" />
            </div>
            <div className='col-2'>
              <img src="/final-project-ecommerce/images/image 7.png" className='mx-auto d-flex' alt="" />
            </div>
            <div className='col-2'>
              <img src="/final-project-ecommerce/images/image 8.png" className='mx-auto d-flex' alt="" />
            </div>
            <div className='col-2'>
              <img src="/final-project-ecommerce/images/image 9.png" className='mx-auto d-flex' alt="" />
            </div>
            <div className='col-2'>
              <img src="/final-project-ecommerce/images/image 10.png" className='mx-auto d-flex' alt="" />
            </div>
          </div>
        </div>
      </div>
      <div className={`row flex-column-reverse position-relative flex-lg-row ${styles.bannerArea} overflow-hidden`}>
        ...
        <div className={`col-12 col-lg-6 ${styles.imgArea}`}>
          <div className='d-flex justify-content-center'>
            <img src="/final-project-ecommerce/images/bannerpng.png" alt="" className={` img-fluid ${styles}`} />
          </div>
        </div>
      </div>
    </div>
