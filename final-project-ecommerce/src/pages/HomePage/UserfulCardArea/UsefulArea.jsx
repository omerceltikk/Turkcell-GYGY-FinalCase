      ...
      <div className="row gy-4 pb-6">
        <div className="col-12 col-lg-4">
          <div className="card border-0 shadow p-2 rounded-3 h-100">
            <img src="../../../../final-project-ecommerce/images/cardimg1.jpg" className="card-img-top img-fluid rounded-3" alt="..." />
        ...
        <div className="col-12 col-lg-4">
          <div className="card border-0 shadow p-2 rounded-3 h-100">
            <img src="../../../../final-project-ecommerce/images/cardimg3.jpg" className="card-img-top img-fluid rounded-3" alt="..." />
            <div className="card-body">
              <span className={`rounded-pill text-white ${style.usefulCardText} `}>Knowledge</span>
        ...
        <div className="col-12 col-lg-4">
          <div className="card border-0 shadow p-2 rounded-3 h-100">
            <img src="../../../../final-project-ecommerce/images/cardimg2.jpg" className="card-img-top img-fluid rounded-3" alt="..." />
            <div className="card-body">
              <span className={`rounded-pill text-white ${style.usefulCardText} `}>Knowledge</span>
