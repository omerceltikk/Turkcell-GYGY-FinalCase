      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-12 col-lg-7 position-relative d-flex justify-content-center">
            ...
            <img src="https://github.com/omerceltikk/Turkcell-GYGY-FinalCase/tree/main/final-project-ecommerce/images/png1.png" className={`mt-100 ${style.imageContent}`} alt="" />
            </div>
          </div>
        </div>
      </div>
